...
class PendriveTest {
    ...
    public void comparePricePerCapacity() {
        ...
        Pendrive pendrive3 = new Pendrive("Datatraveller", 32, 5002);
        ...
        assertEquals(0, pendrive.comparePricePerCapacity(pendrive3));
    }
    ...
    public void toStringTest() {
        Pendrive pendrive = new Pendrive("Datatraveller", 32, 5000);
        assertEquals("Pendrive{name='Datatraveller', capacity=32, price=5000}", pendrive.toString());
    }
